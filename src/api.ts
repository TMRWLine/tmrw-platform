import type { Athlete, AthleteLocation, MatchedSponsor, MatchSponsorsResponse, OutreachRequest, OutreachResponse, Agreement, Message, SenderType, Campaign, CampaignApplication } from './types';
